...
This module lives outside the upstream kiro/ tree. app_entry.py installs it at
startup so KiroaaS can keep upstream files sync-friendly while still handling
long MCP tool names.
"""
